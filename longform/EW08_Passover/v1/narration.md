# The Passover Lamb — Awakeden eyewitness (long)
**Witness:** A father of a household in Israel on the night of the Passover (representative/archetypal — every household, not one named man) · **Core text:** Exodus 12 · **Type→fulfillment:** a spotless lamb slain, its blood struck on the doorposts to turn away judgment, not a bone broken — fulfilled in Christ our passover (1 Cor 5:7; John 19:33,36; 1 Pet 1:19)
**Status:** v1 draft — Awakeden eyewitness LONG. Archetypal witness, signposted in Beat 1 (no invented name/biography — he stands for every household). the_LORD voices Exo 12:12 + 12:13 (verbatim KJV only, EW-G11). Cross-time reveal (Beat 6) is a SIGNPOSTED reflective device (EW-INV-11): the father sees by later light, never claims he knew of Christ in his moment. Substitution named (firstborn under sentence → lamb dies in his place → Christ the Lamb in ours). The type is the BLOOD that turns away judgment ("when I see the blood"), the spotless lamb, the unbroken bone. No supersession. **v1.1 (2026-07-03): re-paneled on the repaired FULL 5/5 panel** (`_independent_review\20260703-061736\`, all REVISE, no doctrinal blocker — NOTE the panel read a STALE `_panel_clean.md`; the Ex 12:30 heard-speech / 1 Pet 1:19 splice / fear-CTA flags were already fixed, and cursor's "altered Ex 12:23" claim was a FALSE ALARM, verified verbatim vs the KJV cache). Applied the 3 still-real fixes: (1) Beat 3 — Ex 12:6 now attributed ("for the command had said") before the quote (EW-INV-4); (2) Beat 4 — dropped "feast after feast" (witness over-claim: Ex 12:46 came with the ordinance and wilderness Passovers lapsed until Gilgal); (3) Beat 6 — 1 Cor 5:7 now attributed ("the Scripture written after me declares it outright"). **v1.2 (2026-07-03): round-2 panel on the fixed text** (`_independent_review\20260703-083704\`: all REVISE, no doctrinal blocker). Applied the convergent fixes: (a) Beat 5 "still we keep this feast year after year" (anachronism on the FIRST night — cursor+claude) → "the LORD had commanded us to keep this night as a feast for ever" (Ex 12:14, given before midnight); (b) Beat 6 "Without blemish, without spot — the very wordS of my own command" → "Without blemish — the very word" (Ex 12:5 says only "without blemish"; "without spot" is Peter's — claude+codex); (c) Beat 4 Ex 12:23 now attributed ("as Moses had told us from the LORD" — Ex 12:21-23 is Moses to the elders). 🔒 **USER DECISION (2026-07-03): the anonymous ARCHETYPAL witness STAYS — do not rename.** 3 panel voices (gemini/codex/claude) wanted a named witness; the user ruled: keep the archetype. The Beat-1 signpost ("I will not give you my name — I withhold it on purpose, for I was not one man only") is the answer to that flag; future panels raising it are answered, not actioned.  Word-budget trim to re-lock (EW-G3: 1678>1650): Beat 1 signpost tightened (archetype KEPT), Beat 6/7 recap lines cut (-30w; also 'without spot'->'without blemish' in his own pick, Ex 12:5) -> 1648, LOCKED 2026-07-03. **AUDIO RE-SYNTHED 2026-07-03 (panel-fix text, turn-level reuse).**
---
...
And it could not be a poor or broken thing. It had to be perfect:
...
I caught his blood in a basin. Then I took a bunch of hyssop, as we had been told, and I went to my own door:

**"ye shall take a bunch of hyssop, and dip it in the blood that is in the bason, and strike the lintel and the two side posts"**

I painted my doorframe with blood — the two posts and the beam above — red and wet in the torchlight. And then I brought my family inside, and I shut the door, and I did not open it, for the word was plain:

**"none of you shall go out at the door of his house until the morning"**

We were not saved by being good. We were saved by being inside, under the blood. For this was the promise the LORD had bound to that red mark on the wood:

**[the LORD]** **"when I see the blood, I will pass over you, and the plague shall not be upon you to destroy you"**
...
It was not enough that the lamb had died. The blood had to be applied — put out where the judgment would meet it first.

And the second thing was stranger still. When the LORD gave the law of this lamb, He guarded its very bones:
