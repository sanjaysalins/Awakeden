...
F02 = PageSpec(
    ...
    main_scene_still=(
        ...
        "toward her, palm gently open, already raised, not touching anything -- one single thin "
        "thread of blue ink already rising directly from the skin of this exact raised hand, its "
        "root touching his hand and nowhere else; "
        f"{WIDOW_BUILD}, "
...
F04 = PageSpec(
    ...
    main_scene_still=(
        ...
        "Stage 2 dosage: the blue ink motif quietly present -- a few soft blue threads rising "
        "UPWARD ONLY from the back of his hand on the low plank into the air above it, every "
        "thread's root touching his hand directly and going up from there, none descending, none "
        "dripping, none pooling below his hand at any point; at the top of the threads, one soft, "
        "irregular, hazy patch of the same blue pigment, entirely amorphous, with soft feathered "
        "edges and no internal structure of any kind, exactly like a single drop of watercolor "
        "spreading into wet paper, completely without symmetry or distinct segments, touching only "
        "his hand and the air above it, touching no other person and nothing else on the page -- "
        "the plank and the ground beneath and around his hand stay bare, dry, and completely free "
        "of any ink of any kind, every thread behaving like wet ink bled into the paper, smooth "
        "and open, never blot-shaped; the stain remainder formless and matte, never swirl-shaped; "
        "a wide band of untouched clean paper between the threads and the stain remainder at "
        "every point, the threads drawn ON the page, the stain lying IN the paper beneath the "
        "linework."
    ),
    material_closer=(
...
F05 = PageSpec(
    ...
    main_scene_still=(
        ...
        f"{SON_BUILD}, alive, his eyes open -- risen to a seated position ON the open bier's own "
        "tilted boards, his weight visibly pressing down into the wood where he sits, the back of "
        "his seat and the backs of his thighs in full flush contact with the plank's own sloped "
        "surface, his whole body leaning back naturally into that slope rather than sitting bolt "
        "vertical, one hand gripping the plank's near edge for support and balance, clearly "
        "anchored to and resting on the bier -- never floating, never hovering above the boards, "
        "no visible gap of open air anywhere between his body and the plank beneath him, his face "
        "turned toward his mother, his lips closed; "
        ...
        "giving him back -- a few soft threads of blue ink rising directly from the skin of the "
        "back of this exact lifted hand, their roots touching his hand and nowhere else, no gap "
        f"between his hand and the nearest thread; {WIDOW_BUILD}, fully inside the frame, her arms opening toward her "
        ...
        "few soft blue threads rising directly from the back of Jesus's lifted hand into the air "
        "above it, their roots touching his hand and nowhere else; at the top of the threads, one "
        ...
        "watercolor spreading into wet paper, completely without symmetry or distinct segments, "
...
F06 = PageSpec(
    ...
    main_scene_still=(
        ...
        "face beside the gate, small in the midground, the open hand-bier now empty -- the exact "
        "same flat plank-and-two-poles stretcher shape carried and set down earlier in this same "
        "episode, the identical object, now simply propped on its edge against the wall: ONE "
        "single flat rectangular wooden plank, solid and unbroken, with its two long carrying "
        "poles running along its two long edges -- never a ladder, never a rack, never a series of "
        "separate rungs or crossbars, no gaps or open rails anywhere across its flat face -- no "
        "body on it, the linen lying folded in one small pile directly on the plank's own flat "
        "surface near its base, never a coffin, never a casket, never a box, never any raised side "
        "walls, never any lid, fully inside the frame. No stain, ring, or grey blot anywhere in "
...
BACK_COVER = CoverSpec(
    side="back",
    scene=(
        "dawn, outside the gate of Nain; ONE single object in this whole scene is made of wood -- "
        "the open hand-bier, empty, the exact same flat plank-and-two-poles stretcher shape "
        "carried throughout this episode: one flat rectangular plank with its two carrying poles "
        "along its long edges, no raised side walls of any kind, never a box, never a crate, never "
        "a coffin, never a ladder, never rungs. This one bier leans upright at a slight angle "
        "against the drystone wall beside the gate opening, and directly on its own flat plank "
        "surface, its full weight resting down into the tilted wood, a visible shadow cast where "
        "the cloth meets the plank, lies the folded linen: the grave-bands folded in a neat small "
        "pile and, set on top of them, the linen napkin folded together by itself -- the folded "
        "linen sits ON this one leaning bier, nothing else -- no second plank, board, door, or "
        "any other wooden object appears anywhere near the wall or the gate; the road "
        "down toward the rock-cut tombs empty and untraveled; through the gate's opening, the lane "
        "into the village just catching light."
    ),
    lighting=(
    ...
    background_detail=(
        "One small hooked curl of blue ink with a trace of muted gold rises from the folded napkin "
        "on the boards, its whole visible length no longer than a hand's width, curling back "
        "toward its own root like a comma or a fishhook WITHOUT fully closing into a ring -- flat "
        "and two-dimensional, drawn ON the paper's surface, a single continuous brushstroke of "
        "pigment, never a three-dimensional object, never a ring, never a bracelet, never a "
        "bangle, never any piece of jewelry, never metallic, never reflective, never straightening, "
