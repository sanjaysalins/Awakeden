...
JesusInTheBible · series design · 2026-08-20 · hand to producer
...
```json
{
  ...
  "episodes": [
    ...
    { "title": "The Hem", "primary_ref": "Mark 5:28",
      "refs": ["Mark 5:25-34"],
      "theme": "STAIN (12 years unclean) dried at the touch -- core 2 pages VALIDATED 2026-08-20; expand to a full short. New to the catalog." },
    ...
    { "title": "The Father Who Ran", "primary_ref": "Luke 15:20",
      "refs": ["Luke 15:11-32"],
      "theme": "STAIN from the far country, its home-side edge ALREADY dried while he is yet a great way off (the D2 turning variant -- grace moves first). Multi-voice: narrator -> Jesus -> narrator -> son. Shares Parables 'The Father Who Ran'." },
    { "title": "Look and Live", "primary_ref": "Numbers 21:8",
      "refs": ["Numbers 21:4-9", "John 3:14-15"],
      "theme": "OT half of the serpent arc. STAIN on the camp ('we have sinned', Num 21:7) dries per looker; swirl CAPPED at Stage 1 -- the type is not the fulfilment. Shares Types & Shadows 'The Bronze Serpent'." },
    { "title": "Ye Must Be Born Again", "primary_ref": "John 3:14",
      "refs": ["John 3:1-16"],
      "theme": "NT half of the serpent arc -- Jesus himself quotes Numbers 21; the Stage 3 the OT episode withheld is released at John 3:16. FRAY FR1 on Nicodemus ('How can these things be?'). Shares Encounters 'Nicodemus by night'." },
    ...
    { "title": "With His Stripes", "primary_ref": "Isaiah 53:5",
      ...
      "theme": "LONG-FORM season finale. The STAIN TRANSFER: the season's dried rings laid on Him -- the ONE sanctioned page where a motif touches Christ; full panel sign-off required on that page. Shares Jesus-in-OT 'The Suffering Servant'." }
  ]
}
```
...
- This slate design is a SIGNIFICANT plan — run `independent_review.py --type plan` on it before committing series.json. `/cost` gate before any spend.
...
| # | Episode | Text | Source series | Form | Dead ink | Status | Why it earns its place |
|---|---|---|---|---|---|---|---|
| 01 | The Well | John 4:6-30 | Encounters | SHORT | none — swirl only | shipped | The pilot. 8 pages, both ratios, finished 69s film with 4-voice dialogue. The series' proof it works end-to-end. |
| 02 | The Hem | Mark 5:25-34 | — not yet catalogued | SHORT | Stain | 2 pages validated | The Stain's home story: 12 years unclean, dried "straightway" at the touch. Both pages passed on real playback today. |
| 03 | My Lord and My God | John 20:24-29 | Encounters | SHORT | Fray | F01 validated | The Fray's home story. Doubt drawn as Thomas's own broken line against the disciples' steady ink; steadied at "then came Jesus." |
| 04 | Peace Be Still | Mark 4:35-41 | Miracles-as-Signs · QJA (Why Are You Afraid) | SHORT | Fray | F06 validated | "Why are ye so fearful?" (Mark 4:40) — Fray on every disciple, Christ's line dead steady. The storm page already survived the hardest ink-vs-water test. |
| 05 | Talitha Cumi | Mark 5:21-24, 35-43 | — not yet catalogued | SHORT | Fray | new | Mark himself interleaves Jairus with The Hem. "Be not afraid, only believe" (5:36) is a Fray text verbatim — and the two episodes share street, crowd, and refs. |
| 06 | Wherefore Didst Thou Doubt | Matthew 14:25-33 | Miracles-as-Signs (Walking on water) | SHORT | Fray | new | Matt 14:31 is the Fray's own proof text. Peter's line steady while he looks at Jesus, fraying FR1→FR3 as he sees the wind, dead at the caught hand. |
| 07 | Lovest Thou Me | John 21:15-17 | Encounters · QJA (Do You Love Me) | SHORT | Stain | new | Three questions = three pages (the QJA guardrail: the repetition IS the restoration). The stain sits by the charcoal fire — the same fire he denied beside (John 18:18 / 21:9). |
| 08 | Thy Sins Be Forgiven | Mark 2:1-12 | Miracles-as-Signs | SHORT | Stain | new | The text puts forgiveness before walking — so the stain dries one page BEFORE he stands. Two cuts, two miracles, exactly the passage's own order. Scribes' inner speech gets a voice. |
| 09 | Neither Do I Condemn Thee | John 8:2-11 | Encounters | SHORT | Stain | new | A story about writing, in a style made of ink and paper. Stains on her AND on the accusers who leave eldest first (8:9). Never render what He wrote — gesture only. |
| 10 | The Father Who Ran | Luke 15:11-32 | Parables | SHORT | Stain | new | The validated D2 "turning" trick was built for this: the stain's home-side edge already dried while he is "yet a great way off." Grace moves first — in the geometry itself. |
| 11 | Look and Live | Numbers 21:4-9 | Types & Shadows (Bronze Serpent) | SHORT | Stain | new | OT half of the serpent arc. "We have sinned" (21:7) grounds the camp-wide stain; the swirl is CAPPED at Stage 1 — the shadow is not the substance. |
| 12 | Ye Must Be Born Again | John 3:1-16 | Encounters (Nicodemus) | SHORT | Fray (light) | new | NT half of the arc — Jesus himself cites the serpent (3:14). The Stage 3 the OT episode withheld releases at John 3:16. Nicodemus's careful night-questions = FR1. |
| 13 | I AM Hath Sent Me | Exodus 3:11-4:13 | Jesus-in-OT (The Great I AM) | SHORT | Fray | new | Dialogue-native OT: Moses's objections (Fray) against a bush that burns steady and unconsumed. Lands on John 8:58 — the name Jesus takes. |
| 14 | When I See the Blood | Exodus 12:3-13 | Types & Shadows · Jesus-in-OT | LONG | Stain | new | First long-form: a stain on EVERY doorstep, Israel's too — the blood makes the difference, not the merit. Stage 3 only at "Behold the Lamb" (John 1:29). |
| 15 | With His Stripes | Isaiah 53:3-6 | Jesus-in-OT (Suffering Servant) | LONG | Stain — the transfer | finale | Season finale. The one sanctioned page where the Stain touches Christ: "the LORD hath laid on him the iniquity of us all." Every dried ring of the season, paid for here. |

**Motif balance:** 7 Stain · 6 Fray · 1 swirl-only · 1 transfer. **Tested ground:** 4 of 15 already carry validated work (eps 1-4). No motif is ever decoration — each one cites its verse.
...
**The Stage-cap law (new, series-level, gate-able):** OT-type episodes cap the swirl at Stage 1-2. Stage 3 diffusion is reserved for pages where fulfilment in Christ is on-page. This is the project's own spine — "the whole Bible, through Jesus" — made visible in the ink system itself, and it's doctrinally honest: the law had "a shadow of good things to come, and not the very image" (Hebrews 10:1). It's also deterministic — a $0 lint can check every OT page's dosage line before a credit is spent.

**The season-level second arc:** episodes 2, 7, 8, 9, 10, 11 each end with a *dried ring* — a person cleansed. The rings are the season's open question: where did the stains go? The Isaiah 53 finale (ep 15) answers it: "the LORD hath laid on him the iniquity of us all" (53:6). One page — panel-reviewed, the single sanctioned exception to "the Stain never touches Christ" — shows the transfer. Every ring in the season was an IOU; the finale pays it. Same law applies to the Passover long (ep 14): Exodus movements cap at Stage 1; "Behold the Lamb of God" releases Stage 3.
...
- ~$12-18/episode (8 stills ~$4 + clips $5-10 veo/Kling mix + regen buffer + audio). Ledger is truth.

**Long (6-8 min) — untested, designed:**
- ~20-26 spreads, NOT 45 — the page changes function: longer holds (~15-25s) with Focal Tour as a primary treatment on non-hero spreads (the Step-0 table already allows this for long-form).
...
- Real clips on hero spreads only (~1/3); veo-first tiering; ~$22-30/episode.
...
Sequenced so each build adds exactly one new risk on top of proven ground — not all fifteen at once.
...
2. **The Hem — expand to the first full series episode.** Wrap ~4 new pages around the validated F04/F05 pair (the 12 years, the press of crowd, "Who touched my clothes?", the landing) and run the whole pipeline: /narrate → /voice → pages → cut → landing-hold → captions. This is the "ship one complete episode of the new series" milestone, on the most-tested ground we have. *Proves: full-episode Stain arc + the production pipeline end-to-end.* ~$10-14
3. **Peace Be Still — full episode, Fray added.** F06 already survived the hardest ink-vs-water test. Build the full short and add the Fray to the disciples — first test of the Fray on multiple figures at once (Thomas was a single figure), with Christ's line explicitly steady. *Proves: multi-figure Fray + second complete episode.* ~$12-16
...
5. **Look and Live + Ye Must Be Born Again — the arc pair, back to back.** One design pass, two episodes, shared compositions (the pole page and its John 3:14 rhyme). First OT episode of the series, first crowd-scale Stain (the camp), and the first real test of the Stage-cap law — the OT episode must end at Stage 1 and still feel finished as a watch. *Proves: the cross-episode crossing arc + OT entry point.* ~$22-30 for the pair
6. **When I See the Blood — the first long-form (16:9).** Only after five shorts have hardened the grammar. Tests everything section 4 designed: per-movement dose pacing, Focal-Tour-primary economy, DEAD INK at length, and 16:9 at scale with the known aspect-ratio gotchas. /narrate-long + the full panel discipline. *Proves: long-form viability — the gate for ep 15's finale.* ~$22-30

The Isaiah 53 finale deliberately sits after all of this — it needs the season's dried rings to exist before it can pay for them, and its one sanctioned Stain-touches-Christ page carries the heaviest doctrinal review of the whole season.
...
| Governance | This plan itself needs the external panel (`independent_review.py --type plan`) before series.json is committed; every episode keeps the standing narration gate, /cost gate, and eyeball-QC-at-1:1 rules. |

---
Swirls of Life · series design pass, 2026-08-20 · grounded in: constitution.md, series.json, SKILL.md, NORTH_STAR_PROMPT.md, NORTH_STAR_ANIMATION_PROMPT.md, and the validated Hem / Storm / Thomas / Cross test work.
