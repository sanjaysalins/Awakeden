"""The Serpent-Crusher Promised -- step 4: hand-written ink captions over
the finished cut, reusing the shared _short_captions.py burner (same
recipe as every other episode in this cluster).
...
caption zone (CAPTION_Y_FRAC=0.78).
  ...
  .venv\\Scripts\\python.exe poc_living_sketchbook/serpent_crusher_promised/_s4_captions.py
"""
import json
import sys
...
OUT = HERE / "SERPENTCRUSHERPROMISED_living_sketchbook_cc.mp4"
