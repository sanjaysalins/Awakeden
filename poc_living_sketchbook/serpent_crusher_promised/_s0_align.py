...
Source narration folder title is "Old Story. Unfinished."
(PythonProject1/jesus/narration/46_Old_Story._Unfinished/) -- same piece,
different working title than the manifest's own "The Serpent-Crusher
Promised."

  .venv\\Scripts\\python.exe poc_living_sketchbook/serpent_crusher_promised/_s0_align.py
"""
import json
import re
import sys
...
SRC = (Path(__file__).resolve().parents[3] / "PythonProject1" / "jesus" /
       "narration" / "46_Old_Story._Unfinished" / "v1")
