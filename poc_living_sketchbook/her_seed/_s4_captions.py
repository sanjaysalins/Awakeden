"""Her Seed -- step 4: hand-written ink captions over the finished cut,
...
(_s3b_titlecards.py's CARD_DEFS) all sit at cy 0.09-0.36, nowhere near the
...
apply directly, no offsetting.
  ...
  .venv\\Scripts\\python.exe poc_living_sketchbook/her_seed/_s4_captions.py
"""
import json
import sys
...
OUT = HERE / "HERSEED_living_sketchbook_cc.mp4"
