...
SHOTS = [
    ...
    ("s05_line_of_fathers_vertical", [], MODEL,
     ...
     "detail distinguishing one figure from another. Each silhouette's "
     "OUTLINE SHAPE reads as ancient biblical-era dress, not modern "
     "clothing: a long, loose, flowing robe or tunic hanging straight "
     "down from the shoulders all the way to the ankles, wide and "
     "draped, NOT fitted trousers, NOT a modern shirt or jacket shape, "
     "NOT narrow tapered legs -- both hands rest simply together in "
     "front at the waist or hang at the sides, NEVER in pockets (this "
     "era has no pockets) -- arranged in a "
