"""God Hung Up a Snake -- step 3b: overlay the LOCKED sketchbook title/verse
card standard (yellow/black title, red/white-outline quote, red/cream
citation) onto the already-assembled core cut. Ported verbatim from
look_and_live/_s3b_titlecards.py's type_img() -- see memory
sketchbook-title-verse-card-standard-LOCKED-2026-08-11.

  .venv\\Scripts\\python.exe poc_living_sketchbook/god_hung_up_a_snake/_s3b_titlecards.py
"""
import math
import subprocess
import sys
...
def main():
    ...
    final = HERE / "GODHUNGUPASNAKE_living_sketchbook.mp4"
    backup = HERE / "_GODHUNGUPASNAKE_prewatermark_nocards.mp4"
