...
JOBS = {
 ...
 "john_watching": ("a CLOSE shot of a young disciple at the foot of the cross, his young face filling the frame, flinching and grief-stricken as he looks upward, one hand gripping the cloak at his chest, hard storm light on his clean young face, vertical, 1st-century", None),
