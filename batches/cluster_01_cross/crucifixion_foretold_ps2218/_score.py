#!/usr/bin/env python
"""The Crucifixion Foretold (Ps 22:18 / John 19:24) — $0 score: lonely_searching_a ->
sacred_grace_rise_a, grace landing on 'It was the plan' (56.1s). Ducked under narration;
dips under the garments bar and the fulfilment bar; thinned under the CTA."""
...
OUT = HERE / "visual" / "crucifixion_foretold_ps2218_scored.mp4"
DARK, GRACE = MUS / "lonely_searching_a.mp3", MUS / "sacred_grace_rise_a.mp3"
TOTAL = 72.54 + 1.5                      # +1.5s outro hold on the mercy hand

fc = (
    f"[1:a]atrim=0:56.0,aformat=sample_fmts=fltp:channel_layouts=stereo:sample_rates=44100[d];"
    ...
    f"volume=volume=0.35:enable='between(t,31.5,37.1)',"
    f"volume=volume=0.4:enable='between(t,41.2,48.4)',"
    f"volume=volume=0.5:enable='between(t,63.3,{TOTAL})'[mus];"
